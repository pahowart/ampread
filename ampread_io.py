...
#
# Please note that there is no error checking implemented. That means that if there is
# an issue with the adafruit io site this python script will error out. If you want to
# avoid this I suggest that you use MQTT instead of the REST API for sensor data upload
# and implement error checking. You could also use upstart to restart this python script if it
# errors out.
#
# This code is free to use, copy or distribute in anyway you see fit.
#
