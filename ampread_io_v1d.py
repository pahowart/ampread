...
while True:
    ...
    try:
        ...
        # Send a data item with value ampsA1 to the 'A2' feed
        # Assumes you have set up adafruit feed named A2 already on the io adafruit site.
        data = Data(value=ampsA2)
        aio.create_data('A2', data)

        # Send a data item with value ampsA3 to the 'A3' feed
        # Assumes you have set up adafruit feed named A3 already on the io adafruit site.
        data = Data(value=ampsA3)
        aio.create_data('A3', data)
        ...
        kilowatts = ((ampsA0 + ampsA1 + ampsA2 + ampsA3) * voltage) / 1000
